...
사용자의 이력서와 직무에 맞춰 '압박형'과 '친화형'이라는 상반된 페르소나를 가진 AI 면접관과<br> 실전 모의 면접을 진행하고 피드백을 제공하는 서비스입니다.<br>
파인튜닝을 통해 베이스 모델의 중국어 혼입 문제를 0%대로 해결하고,<br> 프롬프트 엔지니어링과의 시너지를 통해 응답 속도를 최대 7초에서 1~2초대로 단축했습니다.
